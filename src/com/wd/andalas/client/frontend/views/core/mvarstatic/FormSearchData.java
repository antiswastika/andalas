...
public class FormSearchData extends VBoxLayoutContainer implements IsWidget {
	...
	private HorizontalLayoutContainer doCreateForm() {
		...
		Boolean debugShowBorders = true;
		int banyakComboBox = 5;
		...
		for (int i=0; i<banyakComboBox; i++) {
			...
			cmbField.setEmptyText("Pilih field...");
			...
			cmbField2 = doCreateComboboxField(comboValues);
			cmbField2.setEmptyText("Pilih field...");
			...
			ComboBox<AnyComboModel> cmbField3;
			cmbField3 = doCreateComboboxField(comboValues);
			cmbField3.setEmptyText("Pilih field...");
			cmbField3.setEditable(false);
			cmbField3.setTriggerAction(TriggerAction.ALL);	
			vlcCol3.add(new FieldLabel(cmbField3, ""), new VerticalLayoutData(-1, -1));
		}
		...
		//Terapkan
		//===========================================================
		hlcMain.add(vlcCol1, new HorizontalLayoutData(0.3, -1, new Margins(10, 1, 10, 10)));
		hlcMain.add(vlcCol2, new HorizontalLayoutData(0.2, -1, new Margins(10, 1, 10, 1)));
		hlcMain.add(vlcCol3, new HorizontalLayoutData(0.5, -1, new Margins(10, 10, 10, 1)));
